...
#ifndef CPPUTILS_COMPILER_WARNINGS_PUSH_POP
#define CPPUTILS_COMPILER_WARNINGS_PUSH_POP
#define CPPUTILS_COMPILER_WARNINGS_PUSH_POP_defined_here
#endif
#include <cinternal/disable_compiler_warnings.h>
#ifdef CPPUTILS_COMPILER_WARNINGS_PUSH_POP_defined_here
